export { FetchError, getContentType, getPodOwner, getResourceInfo, getSourceIri, getSourceUrl, isContainer, isPodOwner, isRawData } from './resource/resource.mjs';
export { deleteFile, getFile, overwriteFile, saveFileInContainer } from './resource/file.mjs';
export { changeLogAsMarkdown, createContainerAt, createContainerInContainer, createSolidDataset, deleteContainer, deleteSolidDataset, getContainedResourceUrlAll, getSolidDataset, saveSolidDatasetAt, saveSolidDatasetInContainer, solidDatasetAsMarkdown } from './resource/solidDataset.mjs';
export { mockContainerFrom, mockFetchError, mockFileFrom, mockSolidDatasetFrom } from './resource/mock.mjs';
export { ThingExpectedError, asIri, asUrl, createThing, getThing, getThingAll, isThing, removeThing, setThing, thingAsMarkdown } from './thing/thing.mjs';
...
export { addBoolean, addDatetime, addDecimal, addInteger, addIri, addLiteral, addNamedNode, addStringNoLocale, addStringWithLocale, addTerm, addUrl } from './thing/add.mjs';
export { setBoolean, setDatetime, setDecimal, setInteger, setIri, setLiteral, setNamedNode, setStringNoLocale, setStringWithLocale, setTerm, setUrl } from './thing/set.mjs';
export { removeAll, removeBoolean, removeDatetime, removeDecimal, removeInteger, removeIri, removeLiteral, removeNamedNode, removeStringNoLocale, removeStringWithLocale, removeUrl } from './thing/remove.mjs';
