...
<head>
    <title>Code coverage report for tests/utils/solid-auth-cli/solid-auth-cli.fetch.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">tests/utils/solid-auth-cli</a> solid-auth-cli.fetch.js</h1>
        <div class='clearfix'>
...
function setRestHandlers(handlers){
  <span class="missing-if-branch" title="if path not taken" >I</span>if(typeof handlers !="undefined"){
<span class="cstat-no" title="statement not covered" >    rest = new Rest ( handlers ); </span>
  }
  else <span class="missing-if-branch" title="else path not taken" >E</span>if(typeof rest==="undefined") {
...
async function fetch(url,request){
    <span class="missing-if-branch" title="else path not taken" >E</span>if( url.match(/^(file:|app:)/) ){
...
<span class="cstat-no" title="statement not covered" >    request.method = request.method || 'GET';</span>
<span class="cstat-no" title="statement not covered" >    request.headers = request.headers || {};</span>
    /* if( session ) {
...
<span class="cstat-no" title="statement not covered" >    return crossFetch(url,request);</span>
}
/*
