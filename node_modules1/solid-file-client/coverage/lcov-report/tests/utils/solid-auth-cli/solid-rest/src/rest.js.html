...
<head>
    <title>Code coverage report for tests/utils/solid-auth-cli/solid-rest/src/rest.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../index.html">All files</a> / <a href="index.html">tests/utils/solid-auth-cli/solid-rest/src</a> rest.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">85.43% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>217/254</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>142/186</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">89.14% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>197/221</span>
            </div>
...
<span class="cline-any cline-yes">8x</span>
<span class="cline-any cline-yes">8x</span>
<span class="cline-any cline-yes">4815x</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4815x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">24069x</span>
<span class="cline-any cline-yes">24069x</span>
<span class="cline-any cline-yes">24069x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">2340x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4941x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4941x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4921x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3929x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3878x</span>
...
constructor( handlers,auth,sessionId ) {
  const Global = (typeof window !="undefined") ? <span class="branch-0 cbranch-no" title="branch not covered" >window</span>
               : (typeof global !="undefined") ? global
               : <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
  patch = Global.$rdf ? new RestPatch(Global.$rdf) : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
  this.storageHandlers = {}
  <span class="missing-if-branch" title="if path not taken" >I</span>if( typeof handlers ==="undefined" || handlers.length===0) {
<span class="cstat-no" title="statement not covered" >    if( typeof window ==="undefined") {</span>
      let File = <span class="cstat-no" title="statement not covered" >require('./file.js');</span>
      let Mem = <span class="cstat-no" title="statement not covered" >require('./localStorage.js');</span>
<span class="cstat-no" title="statement not covered" >      handlers = [ new File(), new Mem() ]</span>
    }
    else {
<span class="cstat-no" title="statement not covered" >      try {</span>
        let Bfs = <span class="cstat-no" title="statement not covered" >require('./browserFS.js');</span>
<span class="cstat-no" title="statement not covered" >        handlers = [ new Bfs() ]</span>
      }
      catch{<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(e</span>)=&gt;{<span class="cstat-no" title="statement not covered" >alert(e)}</span>}</span>
    }
  }
...
addFetch( auth,sessionId ) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if(typeof auth.Session === 'function'){
<span class="cstat-no" title="statement not covered" >    auth = new auth.Session(</span>
      {
  ...
  auth.fetch = (uri,options) =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if(uri.startsWith('http') ){
<span class="cstat-no" title="statement not covered" >      return originalFetch(uri,options)</span>
    }
    else {
...
&nbsp;
storage(options){
  const prefix = (typeof options==="string") ? <span class="branch-0 cbranch-no" title="branch not covered" >options </span>: options.rest_prefix
  <span class="missing-if-branch" title="if path not taken" >I</span>if(!this.storageHandlers[prefix]) <span class="cstat-no" title="statement not covered" >throw "Did not recognize prefix "+prefix</span>
  return this.storageHandlers[prefix]
}
&nbsp;
<span class="fstat-no" title="function not covered" >as</span>ync itemExists(pathname,options){
<span class="cstat-no" title="statement not covered" >  return (await this.storage(options).getObjectType(pathname, options))[1]</span>
}
&nbsp;
&nbsp;
async fetch(uri, options = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
  let self = this
...
/**/
  ...
  */
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options.scheme.startsWith('file')) {
<span class="cstat-no" title="statement not covered" >    options.url = Url.format(url)</span>
<span class="cstat-no" title="statement not covered" >    pathname = Url.fileURLToPath(options.url)</span>
<span class="cstat-no" title="statement not covered" >    options.rest_prefix = 'file'</span>
<span class="cstat-no" title="statement not covered" >    path = libPath</span>
  }
  else {
    options.url = decodeURIComponent(uri)
  ...
  options.mungedPath = path || <span class="branch-1 cbranch-no" title="branch not covered" >libPath</span>
&nbsp;
  /**/
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if(!self.storage){
<span class="cstat-no" title="statement not covered" >    if(self.storageHandlers) {</span>
<span class="cstat-no" title="statement not covered" >      self.storage=<span class="fstat-no" title="function not covered" >()</span>=&gt;{<span class="cstat-no" title="statement not covered" >return self.storageHandlers[prefix]}</span></span>
    }
    else {
<span class="cstat-no" title="statement not covered" >      self.storage=<span class="fstat-no" title="function not covered" >()</span>=&gt;{<span class="cstat-no" title="statement not covered" >return self.storageHandlers[options.rest_prefix]}</span></span>
    }
  }
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (objectType === "Container" &amp;&amp; !options.url.endsWith('/')) <span class="cstat-no" title="statement not covered" >options.url = `${options.url}/`</span>
...
&nbsp;
    ...
    else <span class="missing-if-branch" title="else path not taken" >E</span>if( objectType==="Resource" ){
...
&nbsp;
  ...
  */
  if( options.method==="POST"){
    ...
    let slug = options.headers.Slug || options.headers.slug || <span class="branch-2 cbranch-no" title="branch not covered" >options.slug</span>
...
//      Object.assign(resOptions.headers, { location: mapPathToUrl(pathname, options) + '/' })
    ...
    else <span class="missing-if-branch" title="else path not taken" >E</span>if( link &amp;&amp; link.match("Resource")){
      options.resourceType="Resource"
      slug = await _getAvailableUrl(pathname, slug, options)
      pathname = _mungePath(pathname, slug, options)
      <span class="missing-if-branch" title="if path not taken" >I</span>if (isLink(pathname, options)) <span class="cstat-no" title="statement not covered" >return _response(null, resOptions, 405)</span>
...
//      Object.assign(resOptions.headers, { location: mapPathToUrl(pathname, options) })
  ...
  */
  if (options.method === 'PUT' ) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if(objectType==="Container") <span class="cstat-no" title="statement not covered" >return _response(null, resOptions, 409)</span>
    const [status, undefined, headers] = await self.storage(options).makeContainers(pathname,options)
    Object.assign(resOptions.headers, headers)
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if(status !== 200 &amp;&amp; status !== 201) <span class="cstat-no" title="statement not covered" >return _response(null, resOptions, status)</span>
...
&nbsp;
  ...
  /* PATCH
  */
  <span class="missing-if-branch" title="else path not taken" >E</span>if (options.method === 'PATCH' ) {
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if(!patch){
<span class="cstat-no" title="statement not covered" >       console.log( 'TO USE PATCH, YOU MUST IMPORT rdflib IN YOUR MAIN SCRIPT AND SET global.$rdf = $rdf');</span>
<span class="cstat-no" title="statement not covered" >       return _response( null, resOptions, 405);</span>
    }
&nbsp;
    ...
    if (objectExists) {
      const [status, contents, headers] = await self.storage(options).getResource(pathname,options)
      content = typeof contents === 'string' ? contents : <span class="branch-1 cbranch-no" title="branch not covered" >contents.toString()</span>
    }
...
&nbsp;
    ...
    } catch (e) { <span class="cstat-no" title="statement not covered" >throw _response(e, resOptions, parseInt(e)) </span>}
&nbsp;
    // PUT content to file
    if (!objectExists) {
      const [status, undefined, headers] = await self.storage(options).makeContainers(pathname,options)
...
&nbsp;
    //Object.assign(resOptions.headers, putHeaders) // Note: The headers from makeContainers are also returned here
&nbsp;
    let returnStatus = (putStatus === 201)  ? 200 : <span class="branch-1 cbranch-no" title="branch not covered" >putStatus</span>
...
&nbsp;
   ...
   */
  function _response(body, options, status = <span class="branch-0 cbranch-no" title="branch not covered" >options.status)</span> {
...
&nbsp;
  async function _container2turtle( pathname, options, contentsArray ){
    <span class="missing-if-branch" title="if path not taken" >I</span>if(typeof self.storage(options).container2turtle != "undefined")
<span class="cstat-no" title="statement not covered" >      return self.storage(options).container2turtle(pathname,options,contentsArray)</span>
    let filenames=contentsArray.filter( item =&gt; {
      if(!item.endsWith('.acl') &amp;&amp; !item.endsWith('.meta')){ return item }
    })
&nbsp;
    // cxRes
    <span class="missing-if-branch" title="if path not taken" >I</span>if ( !pathname.endsWith(options.mungedPath.sep) ) <span class="cstat-no" title="statement not covered" >pathname += options.mungedPath.sep</span>
...
&nbsp;
    ...
    if(filenames.length){
      ...
      for(var i=0;i&lt;filenames.length;i++){
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if(ftype==="Container" &amp;&amp; !fn.endsWith("/")) <span class="cstat-no" title="statement not covered" >fn = fn + "/"</span>
        str = str + `  &lt;${fn}&gt;,\n`
&nbsp;
...
&nbsp;
    let headers = (typeof self.storage(options).getHeaders != "undefined")
      ? <span class="branch-0 cbranch-no" title="branch not covered" >self.storage(options).getHeaders(pathname,options)</span>
      : {}
    ...
    headers.allow = headers.allow || (typeof patch !="undefined")
      ...
      : <span class="branch-1 cbranch-no" title="branch not covered" >'OPTIONS,HEAD,GET,POST,PUT,DELETE'    </span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if(!headers['content-type']){
<span class="cstat-no" title="statement not covered" >       delete headers['content-type']</span>
    }
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if( !headers.link ) {
        if( ext === '.acl' ) {
...
async function _deleteContainer(pathname,options){
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (links.length) links.map(async link =&gt; await self.storage(options).deleteResource(link,options))
...
&nbsp;
async function _getAvailableUrl (pathname, slug = <span class="branch-0 cbranch-no" title="branch not covered" >uuidv1(),</span> options) {
...
function _mungePath(pathname, slug, options) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (pathname.includes('\\')) <span class="cstat-no" title="statement not covered" >pathname = pathname.replace(/\\/g, '/');</span>
  return pathname;
}
&nbsp;
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Nov 17 2020 18:49:45 GMT+0100 (heure normale d’Europe centrale)
            </div>
        </div>
