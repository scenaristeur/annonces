    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>241/248</span>
            </div>
...
<a name='L559'></a><a href='#L559'>559</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    for (const i in aclPred) {
      ...
      for (const j in user) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!aclagents[key]) {
          aclagents[key] = {
...
&nbsp;
  ...
  async deleteUserMode (aclAgents, userAgent, userMode, userAccess) {
    if (!Array.isArray(userAgent) || (userMode &amp;&amp; !Array.isArray(userMode)) || (userAccess &amp;&amp; <span class="branch-4 cbranch-no" title="branch not covered" >!Array.isArray(userAccess))</span>) {
      throw toFetchError(new Error('Parameters should be Arrays)'))
    }
    if (userAgent &amp;&amp; userAgent.length) {
      for (const j in userAgent) {
